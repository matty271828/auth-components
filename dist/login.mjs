...
function LoginForm({ onSuccess, onError, redirectUrl }) {
  ...
  return /* @__PURE__ */ jsx("div", { className: "min-h-screen flex items-center justify-center p-4 bg-gray-50", children: /* @__PURE__ */ jsxs(Card, { className: "w-full max-w-md", children: [
    /* @__PURE__ */ jsxs(CardHeader, { className: "space-y-1", children: [
      /* @__PURE__ */ jsx(CardTitle, { className: "text-2xl font-bold text-center", children: "Welcome Back" }),
    ...
    /* @__PURE__ */ jsxs("form", { onSubmit: handleSubmit, children: [
      /* @__PURE__ */ jsxs(CardContent, { className: "space-y-4", children: [
        ...
        /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between", children: [
          /* @__PURE__ */ jsxs("div", { className: "flex items-center space-x-2", children: [
            /* @__PURE__ */ jsx(Checkbox, { id: "remember", disabled: isLoading }),
            /* @__PURE__ */ jsx(Label, { htmlFor: "remember", className: "text-sm font-normal", children: "Remember me" })
          ] }),
          /* @__PURE__ */ jsx("a", { href: "#", className: "text-sm text-primary hover:underline", children: "Forgot password?" })
        ] })
      ] }),
      /* @__PURE__ */ jsxs(CardFooter, { className: "flex flex-col space-y-4", children: [
        ...
        /* @__PURE__ */ jsxs("p", { className: "text-sm text-center text-muted-foreground", children: [
          ...
          " ",
          /* @__PURE__ */ jsx("a", { href: "#", className: "text-primary hover:underline font-medium", children: "Create account" })
        ] })
      ] })
    ] })
  ] }) });
